...
SQLiteCondition condition = new SQLiteConditionBuilder()
            ...
            .build();
{{< /highlight >}}
All supported by KittyORM SQLite operators presented at [`net.akaish.kitty.orm.query.conditions.SQLiteOperator`](/kittydoc/net/akaish/kitty/orm/query/conditions/SQLiteOperator.html) enumeration.
